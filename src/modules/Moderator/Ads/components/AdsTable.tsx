...
// type Props = {
//   data: AdTableRowDataProps[]
// }

// const AdsTable = (props: Props) => {
...
//     React.useState<AdTableRowDataProps[] | null>(null)
...
//   }, [searchTerm, filter.option, props.data])
...
//           <FormControl>
//             <InputLabel size='small' id='demo-simple-select-label'>
//               {filter.by === 'address' ? 'Shahar yoki Viloyat' : 'Kategoriya'}
//             </InputLabel>
//             <Select
//               labelId='demo-simple-select-label'
//               size='small'
...
//                   >
//                     {columns.map((column) => {
//                       let value = row[column?.id as keyof AdTableRowDataProps]
